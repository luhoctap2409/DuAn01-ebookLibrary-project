    ...
    private void DangNhap() {
        ...
        if (taikhoan != null && tenDangNhap.equals(taikhoan.getTenDangNhap())) {
            if (!taikhoan.isTrangThai()) {
                DialogHelper.alert(this, "Tài khoản đã bị đừng hoạt động");
                return;
            } else {
                ...
                if (!matKhau.equals(taikhoan.getMatKhau())) {
                    ...
                    if (taikhoan.isVaiTro()) {
                        DialogHelper.alert(this, "Đăng nhập quyền quản trị thành công");
                        this.dispose();
...
//             String matKhau = String.valueOf(txtMatKhau.getPassword());
    ...
    private void initComponents() {
        ...
        pnlMainLogin = new com.ebooks.Compoment.PanelBorder();
        ...
        pnlMainLogin.setBackground(new java.awt.Color(255, 255, 255));
        ...
        pnlMainLogin.add(lblLogo, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 10, -1, -1));
        ...
        pnlMainLogin.add(imageBoder2, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 130, 340, 340));

        jLabel2.setFont(new java.awt.Font("Open Sans", 1, 30)); // NOI18N
        jLabel2.setText("Đăng Nhập vào Nerds");
        pnlMainLogin.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 140, -1, -1));
        ...
        pnlMainLogin.add(btnDangNhap, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 390, 160, 40));

        lblTenDangNhap.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        lblTenDangNhap.setText("Tên Đăng Nhập");
        pnlMainLogin.add(lblTenDangNhap, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 220, -1, -1));

        lblMatKhau.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        lblMatKhau.setText("Mật Khẩu");
        pnlMainLogin.add(lblMatKhau, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 300, -1, -1));
        ...
        pnlMainLogin.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(860, 0, 50, 50));

        txtTenDangNhap.setBackground(new java.awt.Color(220, 250, 220));
        txtTenDangNhap.setBorder(null);
        txtTenDangNhap.setText("ThaoLH");
        txtTenDangNhap.setMargin(new java.awt.Insets(2, 20, 2, 20));
        ...
        pnlMainLogin.add(txtTenDangNhap, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 250, 320, 40));
        ...
        pnlMainLogin.add(txtMatKhau, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 330, 320, 40));

        jLabel8.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        jLabel8.setText("Bạn muốn đăng ký ?");
        pnlMainLogin.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(700, 50, -1, -1));
        ...
        pnlMainLogin.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(840, 50, -1, -1));

        javax.swing.GroupLayout layout = new javax.swing.GroupLayout(getContentPane());
        getContentPane().setLayout(layout);
        layout.setHorizontalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(pnlMainLogin, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 912, javax.swing.GroupLayout.PREFERRED_SIZE)
        );
        layout.setVerticalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(pnlMainLogin, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 550, javax.swing.GroupLayout.PREFERRED_SIZE)
        );
...
//    }
    ...
    private com.ebooks.Compoment.PanelBorder pnlMainLogin;
