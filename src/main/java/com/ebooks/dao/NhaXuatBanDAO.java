...
public class NhaXuatBanDAO {
    ...
    public List<NhaXuatBan> selectByKeyword(String name, String location) {
        String sql = "SELECT * FROM NhaXuatBan WHERE tenNXB  LIKE ? OR diaChiNXB LIKE ? ";
        return select(sql, "%" + name + "%", "%" + location + "%");
    }
