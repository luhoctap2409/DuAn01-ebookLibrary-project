...
public class TheLoaiDAO {
    ...
    public void insert(TheLoai entity) {
        String sql="INSERT INTO TheLoai (tenTheLoai, moTaTheLoai, ngayTao, tenDangNhap) VALUES (?, ?, ?, ?)";
    ...
    public void update(TheLoai entity) {
        String sql="UPDATE TheLoai SET tenTheLoai=?, moTaTheLoai=?, ngayTao=? , tenDangNhap=? WHERE maTheLoai=?";
        JdbcHelper.executeUpdate(sql,
                entity.getTenTheLoai(),
                entity.getMoTaTheLoai(),
                entity.getNgayTao(),
